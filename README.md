# 简介
   ...
   双向喜欢后配对聊天的交友app全套程序，后端基于java springboot 架构，缓存使用redis，即时通讯使用 websocket+netty,前端基于uniapp ,适配 app，小程序，h5端。实现功能包含有 交友卡片左右划，即时通讯， 聊天 ，社区， 个人中心，编辑资料，已对接微信公众号支付，内容合法性，人脸检测等，定位使用高德地图，用户所发文字和图片接入百度内容检测api，对非法内容进行检测，和识别用户上传图片是否为真人相册等。
# 程序
程序包含: 
1.客户端（兼容app,小程序，h5)
...
# 技术架构
前端：uniapp uviewUI
后端：java springboot mysql netty+websocket redis 
运营管理端：vue
